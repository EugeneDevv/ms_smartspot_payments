...
public class ServiceRegistry {
    ...
    public ServiceRegisterResponse register(ServiceRegisterRequest request) {
        if (repository.existsByName(request.getName())) {
            throw new AlreadyExistsException("Service already registered: " + request.getName());
        }
    ...
    public ServiceRegisterResponse rotateSecret(String serviceId) {
    ...
    ServiceRegisterResponse toResponse(RegisteredServiceEntity entity, String secret) {
