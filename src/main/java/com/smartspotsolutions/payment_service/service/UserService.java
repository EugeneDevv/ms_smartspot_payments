...
public interface UserService {
     ...
     *
     * @param request The {@link UserRegisterRequest} containing the necessary details for user creation.
     ...
     *
     * @param request The {@link UserUpdateRequest} containing the fields to be updated.
