...
public class PaymentServiceImpl {
    ...
    @Transactional
    public PaymentInitiationResponse initiatePayment(PaymentRequest request) throws JsonProcessingException {
        ...
        return PaymentInitiationResponse.builder().status(PaymentStatus.FAILED).message("Invalid payment method").build();
    }
...
//        PaymentCompletionRequest completionRequest = new PaymentCompletionRequest();
