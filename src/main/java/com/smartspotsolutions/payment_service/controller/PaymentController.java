...
import com.smartspotsolutions.payment_service.io.request.InitiateStkPushRequest;
...
public class PaymentController {
    ...
    public PaymentInitiateResponse initiatePayment(@RequestBody PaymentRequest request) throws JsonProcessingException {
        log.info("Initiating payment with request: {}", request);
        return paymentService.initiatePayment(request);
    }

    @PostMapping("/send")
    public JsonNode sendStkPush(@RequestBody @Valid InitiateStkPushRequest request) {
        try {
    ...
    public void darajaCallback(@RequestBody JsonNode payload) {
